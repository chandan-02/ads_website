...
import ShopBuyBrandSlider from "../../components/ShopByBrand/ShopByBrandSlider";
            ...
            <div className=" flex flex-col gap-[3rem]">
              ...
              <div>
                <div className="flex justify-between items-center mb-[3rem] ml-[2.1rem]">
                  ...
                  <span className="underline underline-offset-4 text-[#EE2841] font-bold md:text-[1rem] md:text-2xl cursor-pointer">
                    View All
                  </span>
                </div>
